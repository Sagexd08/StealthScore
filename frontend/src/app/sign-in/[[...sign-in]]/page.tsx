...
import { Shield, ArrowLeft, Sparkles, Lock, Zap } from 'lucide-react'
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              >
                <div className="relative bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 p-4 rounded-2xl shadow-2xl overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-700 opacity-0 hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
              ...
              <motion.h2
                ...
                className="text-xl font-semibold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-3"
              >
                Stealth Score
              </motion.h2>
              ...
              >
                Sign in to access your privacy-preserving pitch analysis
              </motion.p>
              ...
              >
                <div className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-500/30">
                  ...
                  <span className="text-green-300 text-xs font-medium">AES-256</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full border border-blue-500/30">
                  ...
                  <span className="text-blue-300 text-xs font-medium">Lightning Fast</span>
                </div>
            ...
            >
              ...
              <div className="relative z-10">
                <SignIn
                  appearance={{
                    elements: {
                      formButtonPrimary: "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 w-full shadow-lg hover:shadow-xl hover:scale-105 transform font-montserrat",
                      ...
                      formFieldInput: "bg-white/10 border border-white/20 text-white placeholder-white/50 rounded-xl px-4 py-4 w-full backdrop-blur-sm focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 font-montserrat",
                      formFieldLabel: "text-white/90 font-medium mb-2 block font-montserrat",
                      footerActionText: "text-white/70 font-montserrat",
                      footerActionLink: "text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200 font-montserrat",
                      identityPreviewText: "text-white/80 font-montserrat",
                      identityPreviewEditButton: "text-blue-400 hover:text-blue-300 text-sm transition-colors duration-200 font-montserrat",
